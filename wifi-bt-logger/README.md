...
```sh
JAVA_HOME=/opt/homebrew/opt/openjdk@17 /opt/homebrew/Cellar/gradle/9.3.1/libexec/bin/gradle -p /Users/kyledavis/Documents/Projects/wifi-bt-logger --no-daemon assembleRelease
```
...
## Notes
- Requires location, Bluetooth, Wi‑Fi, and phone state permissions.
- Logs are saved to the device Downloads folder.

## Disclaimer

This software is provided as-is. The author is not liable for any issues, damage, or harm arising from installation or use of this app.
